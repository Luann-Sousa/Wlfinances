...
<p>*Styled-components [ -> yarn add styled-compements | yarn add @types/styled-components] => lib bastante utilizada para estilizar nossas aplicação quanto ela seja mobile or desktop.</p>
